// lib/widgets/assign_operations_dialog.dart
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:gosolarleads/providers/operations_provider.dart';

class AssignOperationsDialog extends ConsumerWidget {
  final String leadId;
  const AssignOperationsDialog({super.key, required this.leadId});
            ...
            itemBuilder: (ctx, i) {
              ...
              return ListTile(
                ...
                trailing: ElevatedButton(
                  onPressed: () async {
                    await ref.read(operationsServiceProvider).assignOperations(
                          leadId: leadId,
                          opsName: name,
                          opsUid: uid,
                        );
