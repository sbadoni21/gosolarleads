                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if ((slaTitle == 'Registration SLA' &&
                        ...
                        (slaTitle == 'Installation SLA' &&
                            lead.installationSlaBreachRecordedAt != null)) ...[
                      const SizedBox(height: 8),
                      Text(
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                call.startedAt != null
                    ? DateFormat('dd MMM yyyy, hh:mm a').format(call.startedAt!)
                    : 'Unknown time',
                style: const TextStyle(
                  fontSize: 13,
                  fontWeight: FontWeight.w600,
...
Future<void> _initiateCallWithRecording(
    BuildContext context, LeadPool lead, WidgetRef ref) async {
  final recordingService = LocalCallRecordingService();
      ...
      content: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: const [
                Icon(Icons.cloud_upload, size: 16, color: AppTheme.primaryBlue),
                SizedBox(width: 8),
                Expanded(
                  child: Text(
